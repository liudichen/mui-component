...
const getColor = (
  ...
  rawStatus?: string,
  type?: shownType,
  statusColorConvert?: IStatusConvertRelateProps["statusColorConvert"],
  statusTypeConvert?: IStatusConvertRelateProps["statusTypeConvert"],
  statusConvert?: IStatusConvertRelateProps["statusConvert"]
) => {
  if (color) {
    return color;
  }
...
const getText = (
  ...
  rawStatus?: string,
  statusConvert?: IStatusConvertRelateProps["statusConvert"],
  statusTextConvert?: IStatusConvertRelateProps["statusTextConvert"]
) => {
  if (text) {
    return text;
  }
